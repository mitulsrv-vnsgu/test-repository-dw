...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapReadinglist() {
    Get.toNamed(AppRoutes.readingListScreen);
  }
  ...
  onTapSearchhistory() {
    Get.toNamed(AppRoutes.searchHistoryScreen);
  }
  ...
  onTapNewSavedItem() {
    Get.toNamed(AppRoutes.newSavedItemScreen);
  }
}
